<div class="flex items-center gap-3 select-none">
  <svg
    ...
    viewBox="0 0 36 40"
    fill="none"
    class="w-auto h-5 sm:h-[22px] transition-transform duration-300 hover:scale-105"
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
  ...
  <span class="font-sans text-base sm:text-lg font-semibold tracking-tight text-white">
    Web<span class="text-white/50 font-normal">Craft</span>
  </span>
</div>